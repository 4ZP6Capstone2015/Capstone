...
%% YT: This can't all be in the intro...
%% \edinsert{JG}
...
%% \edinsert{JG}{\subsection{Expression}\label{subsec:Expr}}

%% \edinsert{JG}{\section{Event-Condition Action (E.C.A.) Rules and Definitions}\label{sec:ECA}}

%% \edinsert{JG}{\section{Users}\label{sec:Users}}
%% \edinsert{JG}{\subsection{Background}\label{subsec:Backgnd}}
