...
This project assumes that those who may use Ampersand and by extension this 
project, are computer literate and work in the field of business or 
engineering. We assume our users are knowledgeable about computer systems and 
able to understand and follow error messages. Furthermore, we assume that any 
system that can run Ampersand, can run EFA.
