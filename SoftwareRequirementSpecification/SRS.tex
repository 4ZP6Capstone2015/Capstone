...
However, since Ampersand is a successor of CC, %TODO{JG}:cite Rule design (p.10) 
...
manually correct data. %TODO{JG}{CITE Rules Based Design p.153}
...
and the purpose it drives %TODO{JG:}{cite “ Deriving Functional Specification …” p. 2}. 
