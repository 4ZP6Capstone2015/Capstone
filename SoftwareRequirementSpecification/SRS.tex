...
attributes of the information system unambiguously.\edcomm{JG}{Good job! what 
do you think about saying "to unambiguously capture attributes of the 
...
engineer; this can be an error prone process. \edcomm{JG}{what do you think 
about: "which can be prone to human error"?}
...
It is proven \edcomm{YT}{This is 'proven' because someone told me we have a
  ...
  subsets, I pushed it; look for "subsets" by Joosten(both)}that for the subset 
  of
...
and commonly used in market ready business rule engines. %TODO: cite rule 
%design.p:8-9
\begin{verbatim}
...
%TODO{JG}: Complete the blurb for introducing functional requirements and its 
%importance
...
each model. \edcomm{JG}{A hardline can be added later, but as of now since we 
are not running scenarios, it is difficult to pin point where the cut off 
should be. An upperbound was considered, but that can added later}
