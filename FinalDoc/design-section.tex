...
\begin{description}
    ...
    $\lnot x \in xs$.
    \lstinline{NotElem} is the witness for 
    \lstinline{IsNotElem}. 
...
\edcomm{YT}{This section now talks about precisely this algorithm. (not quite done though)
 Although issues about tables are talked about in the appendix in more detail --- 
 maybe have a reference or move it here instead}
