...
structures.  \\
\hline
Data.Char &  A module that provides support for characters and 
operations 
on characters.  \\
\hline
Data.Coerce  & Provides safe coercions between data types; allows user 
to 
...
off of Philip Wadler's 1997 "A prettier printer", used to show SQL 
queries 
...
\hline
Unsafe.Coerce &  A helper module that converts a value from any type to 
any 
...
independent of its environment to be considered safe. Any I/O 
computation 
...
\begin{figure}[!ht]
    ...
    \begin{figure}[!ht]
        ...
        inhabitted if and only if the
        predicate is true.  Therefore, pattern matching on the 
        predicate witness can be
