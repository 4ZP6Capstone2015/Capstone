...
%% Example usage....
\systemTest{exampleSysTest}  %% Test label, should be unique
{Example system test}  %% Test name
{What type of test is this?}  
{When will this test be done?}
{Which requirements does this test address?}
{What is the input to this test?}
{What is the desired output of this test?}
{How to do the test?}
