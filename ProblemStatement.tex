...
%% all.
%% JG: EFA is the title, the projected needed a name and when I asked both of you 
%% to look over the Project Registeration because we didnt have a name for the project
%% neither of you two said anything and we had to hand it in so EFA like it says on the 
%% title stands for ECA for Ampersand.
%%
%%
...
%% JG: they're tools that Ampersand can provide. If either knew exactly
%% what you would like to go in the problem statement, you could help me
%% write it, instead of waiting till its done and tearing it apart..
